...
const file_hello_proto_rawDesc = "" +
	...
	"\fHelloService\x12!\n" +
	"\aReceive\x12\t.HelloMsg\x1a\t.HelloMsg\"\x00B\vZ\t./;protosb\x06proto3"
...
var file_hello_proto_goTypes = []any{
	(*HelloMsg)(nil), // 0: HelloMsg
}
var file_hello_proto_depIdxs = []int32{
	0, // 0: HelloService.Receive:input_type -> HelloMsg
	0, // 1: HelloService.Receive:output_type -> HelloMsg
