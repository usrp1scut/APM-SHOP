...
func (c *userServiceClient) GetUserInfo(ctx context.Context, in *User, opts ...grpc.CallOption) (*User, error) {
...
func (UnimplementedUserServiceServer) GetUserInfo(context.Context, *User) (*User, error) {
